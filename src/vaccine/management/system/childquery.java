...
public class childquery extends JFrame implements ActionListener {
...
//                 
         ...
         else if(ae.getSource()== b4)
         {
           ...
           String aadhar = t3.getText();
            Conn c = new Conn();
            String str = "insert into childquery(name,feedback,aadhar) values('"+name+"','"+feedback+"','"+aadhar+"')";
        
        try{
            c.s.executeUpdate(str);
           JOptionPane.showMessageDialog(null, "Child's Feedback Added");
           //this.setVisible(false);
    ...
    {
        new childquery().setVisible(true);   //object of the class
    }
}
