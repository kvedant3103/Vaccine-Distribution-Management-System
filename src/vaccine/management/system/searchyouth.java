...
public class searchyouth extends JFrame implements ActionListener{
    ...
    searchyouth()
    {
       ...
       aad.setFont(new Font("Tahoma",Font.PLAIN,17));
        ...
        JLabel l2 = new JLabel("SEARCH YOUTH'S DETAILS");
...
//           
    ...
    {
        new searchyouth().setVisible(true);   //object of the class
    }
}
