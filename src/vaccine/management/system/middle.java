...
public class middle extends JFrame implements ActionListener{
    ...
    middle()
    {
        setTitle("Vaccine Management System");
         ...
         l1 = new JLabel("MIDDLE AGED CITIZEN MODULE");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource() == b2)
        {
            ...
            new viewmiddleaged().setVisible(true);
            this.setVisible(false);
        }
        else if(ae.getSource() == b3)
        {
            System.out.println("search");
             new searchmid().setVisible(true);
            this.setVisible(false);
        }
        else if(ae.getSource() == b4)
        {
            System.out.println("update");
            new updatemiddleaged().setVisible(true);
            this.setVisible(false);
        }
        ...
        {
           new middleagedquery().setVisible(true);
           this.setVisible(false);
        }
    }
