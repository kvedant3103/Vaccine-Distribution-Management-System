...
public class updatesenior extends JFrame implements ActionListener {
    ...
    updatesenior()
    {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Vaccine/Management/System/icons/senior.jpg"));
        ...
        JLabel l2 = new JLabel("UPDATE SENIOR CITIZENS DETAILS");
...
//           
         ...
         else if(ae.getSource()==b3)
        {
          ...
          {
              Conn p = new Conn();
              String sql = "select * from seniorcitizen where aadhar = ?";
...
//           
//           
            String qry = "update seniorcitizen set name='"+name+"',age='"+age+"',gender='"+gender+"',vaccine='"+vaccine+"',status='"+status+"',phone='"+phone+"',email='"+email+"' where aadhar="+t8.getText();
            try{
...
//                 JOptionPane.showMessageDialog(null,"Invalid Aadhar");
    ...
    {
        new updatesenior().setVisible(true);   //object of the class
    }
}
