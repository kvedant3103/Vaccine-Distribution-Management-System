...
public class warriorsquery extends JFrame implements ActionListener {
         ...
         else if(ae.getSource()==b3)
        {
          try
          {
              ...
              {   
                  ...
                  {
                       JOptionPane.showMessageDialog(null,"Please complete your 2nd dose");
                  }
//                 
         ...
         else if(ae.getSource()== b4)
         {
           ...
           String aadhar = t3.getText();
            Conn c = new Conn();
            String str = "insert into warriorsquery(name,aadhar,feedback) values('"+name+"','"+aadhar+"','"+feedback+"')";
        
        try{
            c.s.executeUpdate(str);
           JOptionPane.showMessageDialog(null, "Covid Warrior's query Added");
           //this.setVisible(false);
    ...
    {
        new warriorsquery().setVisible(true);   //object of the class
    }
