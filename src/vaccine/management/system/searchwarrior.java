...
public class searchwarrior extends JFrame implements ActionListener {
    ...
    searchwarrior()
    {
        ...
        JLabel l2 = new JLabel("SEARCH COVID WARRIORS DETAILS");
...
//           
    ...
    {
        new searchwarrior().setVisible(true);   //object of the class
    }
}
