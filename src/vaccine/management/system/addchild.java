...
public class addchild extends JFrame implements ActionListener{
...
//        
        ...
        JLabel l2 = new JLabel("ADD CHILD'S DETAILS");
    ...
    {   
       ...
       // String designation = (String)c1.getSelectedItem();
        ...
        Conn c = new Conn();
        String str = "insert into childeren values('"+name+"','"+age+"','"+gender+"','"+vaccine+"','"+status+"','"+phone+"','"+aadhar+"','"+email+"')";
