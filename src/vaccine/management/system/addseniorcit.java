...
public class addseniorcit extends JFrame implements ActionListener{
...
//        
        ...
        JLabel l2 = new JLabel("ADD SENIOR CITIZENS DETAILS");
    ...
    {   
       ...
       // String designation = (String)c1.getSelectedItem();
        ...
        Conn c = new Conn();
        String str = "insert into seniorcitizen values('"+name+"','"+age+"','"+gender+"','"+vaccine+"','"+status+"','"+phone+"','"+aadhar+"','"+email+"')";
        
        try{
            c.s.executeUpdate(str);
           JOptionPane.showMessageDialog(null, "New Senior Citizen Added");
     ...
     public static void main(String[] args) {
                new addseniorcit().setVisible(true);			
	}
}
