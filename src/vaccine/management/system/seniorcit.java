...
public class seniorcit extends JFrame implements ActionListener{
    ...
    seniorcit()
    {
        setTitle("Vaccine Management System");
         ...
         l1 = new JLabel("Senior Citizen MODULE");
     ...
     public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource() == b2)
        {
            ...
            new viewsenior().setVisible(true);
            this.setVisible(false);
        }
        else if(ae.getSource() == b3)
        {
            System.out.println("search");
            new searchsenior().setVisible(true);
            this.setVisible(false);
        }
        else if(ae.getSource() == b4)
        {
            System.out.println("update");
            new updatesenior().setVisible(true);
            this.setVisible(false);
        }
        ...
        {
            new seniorquery().setVisible(true);
            this.setVisible(false);
        }
    }
