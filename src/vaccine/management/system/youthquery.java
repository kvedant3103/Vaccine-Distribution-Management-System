...
public class youthquery extends JFrame implements ActionListener {
...
//           
         ...
         else if(ae.getSource()==b3)
        {
         ...
         else if(ae.getSource()== b4)
         {
           ...
           String aadhar = t3.getText();
            Conn c = new Conn();
            String str = "insert into youthquery(name,feedback,aadhar) values('"+name+"','"+feedback+"','"+aadhar+"')";
        
        try{
            c.s.executeUpdate(str);
           JOptionPane.showMessageDialog(null, "Youth's query Added");
           //this.setVisible(false);
    ...
    {
        new youthquery().setVisible(true);   //object of the class
    }
}
