...
public class searchchild extends JFrame implements ActionListener {
    ...
    searchchild()
    {
        ...
        JLabel l2 = new JLabel("SEARCH CHILD'S DETAILS");
...
//           
    ...
    {
        new searchchild().setVisible(true);   //object of the class
    }
}
