...
public class seniorquery extends JFrame implements ActionListener {
...
//                 
         ...
         else if(ae.getSource()== b4)
         {
           ...
           String aadhar = t3.getText();
            Conn c = new Conn();
            String str = "insert into seniorquery(name,feedback,aadhar) values('"+name+"','"+feedback+"','"+aadhar+"')";
    ...
    {
        new seniorquery().setVisible(true);   //object of the class
    }
}
