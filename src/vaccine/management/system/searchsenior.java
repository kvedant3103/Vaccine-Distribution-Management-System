...
public class searchsenior extends JFrame implements ActionListener {
    ...
    searchsenior()
    {
        ...
        JLabel l2 = new JLabel("SEARCH SENIOR CITIZENS DETAILS");
...
//           
    ...
    {
        new searchsenior().setVisible(true);   //object of the class
    }
}
