...
public class addmid extends JFrame implements ActionListener{
...
//        
        ...
        JLabel l2 = new JLabel("ADD MIDDLE AGED CITIZENS DETAILS");
    ...
    {   
       ...
       // String designation = (String)c1.getSelectedItem();
        ...
        Conn c = new Conn();
        String str = "insert into middle values('"+name+"','"+age+"','"+gender+"','"+vaccine+"','"+status+"','"+phone+"','"+aadhar+"','"+email+"')";
        
        try{
            c.s.executeUpdate(str);
           JOptionPane.showMessageDialog(null, "New Citizen Added");
